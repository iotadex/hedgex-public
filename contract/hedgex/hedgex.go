...
//
// Solidity: function getPoolPosition() view returns(uint256, uint256, uint256, uint256)
func (_Hedgex *HedgexCaller) GetPoolPosition(opts *bind.CallOpts) (*big.Int, *big.Int, *big.Int, *big.Int, error) {
	var out []interface{}
...
//
// Solidity: function getPoolPosition() view returns(uint256, uint256, uint256, uint256)
func (_Hedgex *HedgexSession) GetPoolPosition() (*big.Int, *big.Int, *big.Int, *big.Int, error) {
...
//
// Solidity: function getPoolPosition() view returns(uint256, uint256, uint256, uint256)
func (_Hedgex *HedgexCallerSession) GetPoolPosition() (*big.Int, *big.Int, *big.Int, *big.Int, error) {
	return _Hedgex.Contract.GetPoolPosition(&_Hedgex.CallOpts)
}
